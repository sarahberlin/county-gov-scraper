...
url = 'http://orangecountyda.org/office/ocda.asp'
soup = bs4.BeautifulSoup((requests.get(url)).text)
soup.select('h1')[0].get_text().encode('utf-8')
...
#creates csv
fieldnames = ['official.name','electoral.district', 'office.name','phone','website', 'address']
