...
def get_councilor_data(page_url):
    ...
    try:
        ...
        councilor_data['office.name'] = "Cook County Commissioner " +soup.select('h1')[0].get_text().encode('utf-8').split(' (')[1].replace(')', ' District')
...
#creates csv
fieldnames = ['official.name','electoral.district', 'office.name','address','phone','website', 'email']
